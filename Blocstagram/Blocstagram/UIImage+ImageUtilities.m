...
- (UIImage *) imageByScalingToSize:(CGSize)size andCroppingWithRect:(CGRect)rect {
    ...
    CGContextRef ctxS = CGBitmapContextCreate(NULL,
                                             newRect.size.width,
                                             newRect.size.height,
                                             CGImageGetBitsPerComponent(self.CGImage),
                                             0,
    ...
    // Draw into the context; this scales the image
    CGContextDrawImage(ctxS, newRect, imageRef);
    
    // Get the resized image from the context and a UIImage
    CGImageRef newImageRef = CGBitmapContextCreateImage(ctxS);
    UIImage *newImage = [UIImage imageWithCGImage:newImageRef scale:self.scale orientation:UIImageOrientationUp];
    ...
    CGImageRef lastImageRef = CGImageCreateWithImageInRect(newImage.CGImage, rect);
    UIImage *image = [UIImage imageWithCGImage:lastImageRef scale:self.scale orientation:self.imageOrientation];
