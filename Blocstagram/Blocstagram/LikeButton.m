...
@property (nonatomic, strong) CircularSpinnerView *spinnerView;
...
- (instancetype) init {
    ...
    if (self) {
        self.spinnerView = [[CircularSpinnerView alloc] initWithFrame:CGRectMake(0, 0, 44, 44)];
