...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    [self setIsWritingComment:YES animated:YES];
    CGPoint cP = _button.center;
    [UIView animateWithDuration:2.0 delay:0 usingSpringWithDamping:.25 initialSpringVelocity:15.0 options:UIViewAnimationTransitionCurlUp animations:^{
        _button.transform = CGAffineTransformMakeScale(0.5, 0.5);
        _button.layer.position = cP;}
